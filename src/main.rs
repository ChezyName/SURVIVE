...
fn main() {
    App::new()
        ...
        .add_systems(OnEnter(AppState::Shop), audio::change_music).add_systems(OnEnter(AppState::GameOver), audio::change_music).add_systems(Update, audio::handle_pause_audio)
